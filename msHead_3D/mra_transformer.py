...
class mra_b0(MRATransformer):
    def __init__(self, img_size, in_chans, patch_size, num_classes, embed_dims, depths, num_heads, drop_path_rate):
        super(mra_b0, self).__init__(
            img_size = img_size, in_chans = in_chans, patch_size = patch_size, num_classes=num_classes, embed_dims=embed_dims, 
